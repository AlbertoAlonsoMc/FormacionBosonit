...
public class Profesor {
    ...
    public Profesor(String usuario, String apellidos, String nombre, String contrasena, String emailCompania, String emailPersonal, String ciudad, String urlImagen, Date fechaCreacion, boolean activado, Date fechaFinalizacion) {
    ...
    public ProfesorOutputDTO toProfesorOutputDTO() {
        return new ProfesorOutputDTO(id, usuario, apellidos, nombre, contrasena, emailCompania, emailPersonal,
